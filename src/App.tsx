...
const APPS_SCRIPT_URL = import.meta.env.VITE_APPS_SCRIPT_URL || 'https://https://script.google.com/macros/s/AKfycbxD1xx4WP7azHjvsWBbWH05LhVz4-sD9QOvq8cs7hjNNoX9Qh3JVEXCjRSmPTrCxnJIJQ/exec';
